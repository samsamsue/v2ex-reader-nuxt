  ...
  <div>
    ...
    <template v-else>
      ...
      <div id="mainContent">
        ...
        <NuxtLink v-if="showShareLink && shareUrl" :to="shareUrl" class="end-link">—— END ——</NuxtLink>
        ...
        <div v-else-if="loadingReplies && !replies.length && total === 0" class="loading">Loading replies...</div>
      </div>
    </template>
  </div>
</template>
