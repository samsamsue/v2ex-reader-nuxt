import{_ as T}from"./CUJuk_TE.js";import{_ as F}from"./CCk-U8a0.js";import{e as N,u as M,r as c,f as O,g as $,o as l,c as d,h as i,i as R,F as L,a as e,j as b,k as P,l as H,b as A,w as Y,d as D,t as p,m as K}from"./Cj70m0yP.js";import{u as q}from"./C6mjBrVN.js";const V={id:"mainContent"},j={id:"list"},J={key:0,class:"list-skeleton"},U=["id"],G={class:"meta"},W=`
<div id="codeMode">
...
`,es=N({__name:"all",setup(X){const g=M(),C=K(()=>g.fullPath||"/all"),w=c(!1),r=c([]),v=c(0),u=c(parseInt(String(g.query.p||0))),k=c("加载中..."),f=c(null),y=c(!0),x=c(!1);let _=!1,S=!1;const I=()=>window.scrollTo({top:0}),B=()=>window.location.reload(),E=a=>sessionStorage.setItem("v2_last_code",a),m=()=>{document.querySelectorAll(".flash-highlight").forEach(s=>s.classList.remove("flash-highlight"));const a=sessionStorage.getItem("v2_last_code");if(a){const s=document.getElementById("item_"+a);s&&(s.classList.remove("flash-highlight"),s.offsetWidth,s.classList.add("flash-highlight"),sessionStorage.removeItem("v2_last_code"))}},h=async a=>{try{const s=await $fetch("/api/all",{query:{p:a,_t:Date.now()}});return s?.error==="AUTH"?(w.value=!0,null):s}catch{return null}};return q({title:"V2EX Reader",script:[{children:z,tagPosition:"bodyClose"}]}),O(async()=>{if(_)return;_=!0,window.drawFavicons?.(),window.addEventListener("scroll",()=>{S=!0},{once:!0});const a=await h(u.value);a?.items&&(r.value=a.items,v.value=a.count||0),y.value=!1,m();const s=new IntersectionObserver(async o=>{if(!o[0].isIntersecting||!x.value||!S)return;u.value+=1;const n=await h(u.value);n?.items?.length?r.value.push(...n.items):(k.value="到底了",s.disconnect())},{rootMargin:"100px"});f.value&&s.observe(f.value),setTimeout(()=>{x.value=!0},1200);const t=async()=>{if(window.isModeCode||document.visibilityState==="hidden"){setTimeout(t,1e4);return}try{const o=await h(0);o?.count>v.value&&window.startBlink?.(),typeof o?.count=="number"&&(v.value=o.count)}catch{}setTimeout(t,6e4+Math.random()*3e4)};setTimeout(t,6e4),window.addEventListener("pageshow",o=>{o.persisted&&m()})}),$(()=>{m()}),(a,s)=>{const t=T,o=F;return l(),d("div",null,[i(w)?(l(),R(t,{key:0,from:i(C)},null,8,["from"])):(l(),d(L,{key:1},[e("div",{innerHTML:W}),e("div",V,[e("div",{class:"fab-group"},[e("div",{class:"fab",onClick:I},[...s[0]||(s[0]=[e("svg",{xmlns:"http://www.w3.org/2000/svg",width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[e("path",{d:"m18 15-6-6-6 6"})],-1)])]),e("div",{class:"fab",onClick:B},[...s[1]||(s[1]=[b('<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12a9 9 0 0 0-9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path><path d="M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16"></path><path d="M16 16h5v5"></path></svg>',1)])])]),e("div",j,[i(y)?(l(),d("div",J,[...s[2]||(s[2]=[b('<div class="skeleton-line w-80"></div><div class="skeleton-line w-60"></div><div class="skeleton-line w-90"></div><div class="skeleton-line w-70"></div><div class="skeleton-line w-50"></div>',5)])])):P("",!0),(l(!0),d(L,null,H(i(r),n=>(l(),d("div",{key:n.code,class:"item",id:`item_${n.code}`},[A(o,{to:`/t/${n.code}`,onClick:Q=>E(n.code)},{default:Y(()=>[D(p(n.title),1)]),_:2},1032,["to","onClick"]),e("div",G,"@"+p(n.author)+" • "+p(n.time)+" • "+p(n.replies)+"回复",1)],8,U))),128))]),e("div",{id:"loader",ref_key:"loaderEl",ref:f,style:{padding:"40px","text-align":"center",color:"var(--meta)","font-size":"0.9rem"}},p(i(k)),513)])],64))])}}});export{es as default};
