import { _ as _sfc_main$1 } from "./CommentTree-D5k_3yTi.js";
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(_attrs)}><div>${codeModeHtml}</div><div id="mainContent"><div id="newMsgNotify" class="${serverRenderer_cjs_prodExports.ssrRenderClass({ show: vueExports.unref(notifyVisible) })}">检测到新回复</div>`);
...
//# sourceMappingURL=_code_-B8bp6wVm.js.map
