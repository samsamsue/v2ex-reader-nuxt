  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (vueExports.unref(needLogin)) {
        ...
        _push(`</div></div><div id="notifOverlay" class="${serverRenderer_cjs_prodExports.ssrRenderClass({ open: vueExports.unref(showNotif) })}" data-v-6efc7244></div><div id="notifModal" class="${serverRenderer_cjs_prodExports.ssrRenderClass({ open: vueExports.unref(showNotif) })}" data-v-6efc7244><div class="notif-header" data-v-6efc7244><h3 data-v-6efc7244>最新提醒</h3><button class="close-btn" aria-label="关闭" data-v-6efc7244>×</button></div>`);
        if (vueExports.unref(notifLoading) && !vueExports.unref(notifs).length) {
          ...
          serverRenderer_cjs_prodExports.ssrRenderList(vueExports.unref(notifs), (n) => {
            ...
            if (n.payload) {
              _push(`<div class="notif-payload" data-v-6efc7244>${n.payload ?? ""}</div>`);
            } else {
              _push(`<!---->`);
            }
...
//# sourceMappingURL=all-Fie98rHO.js.map
