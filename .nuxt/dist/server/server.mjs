...
import { sanitizeStatusCode, createError as createError$1 } from "C:/Users/Administrator/Documents/XCode/v2/node_modules/.store/h3@1.15.11/node_modules/h3/dist/index.mjs";
...
const _routes = [
  {
    name: "all",
    path: "/all",
    component: () => import("./_nuxt/all-DJlPLwhN.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BS7JX5Lj.js")
  },
  {
    name: "s-code",
    path: "/s/:code()",
    component: () => import("./_nuxt/_code_-Dir1wFDG.js")
  },
  {
    name: "t-code",
    path: "/t/:code()",
    component: () => import("./_nuxt/_code_-BbbEiZPJ.js")
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtPage, vueExports.mergeProps({ keepalive: "" }, _attrs), null, _parent));
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vueExports.defineAsyncComponent(() => import("./_nuxt/error-404-DKeVsXGm.js"));
    const _Error = vueExports.defineAsyncComponent(() => import("./_nuxt/error-500-D2OjJt6k.js"));
      ...
      serverRenderer_cjs_prodExports.ssrRenderSuspense(_push, {
        default: () => {
          if (vueExports.unref(abortRender)) {
            ...
            _push(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(AppComponent), null, null, _parent));
          }
        },
        _: 1
      });
