  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.requireAuth && needLogin.value) {
        ...
        if (topicReady.value) {
          _push(`<div class="content">${(_b = topicContent.value) != null ? _b : ""}</div>`);
...
//# sourceMappingURL=TopicPage-DE4FRFLD.mjs.map
