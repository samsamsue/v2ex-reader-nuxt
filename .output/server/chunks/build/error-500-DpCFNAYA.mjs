...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-b02c1a1c><div class="-bottom-1/2 fixed h-1/2 left-0 right-0 spotlight" data-v-b02c1a1c></div><div class="max-w-520px text-center" data-v-b02c1a1c><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-b02c1a1c>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.status)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-b02c1a1c>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.description)}</p></div></div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.store/nuxt@3.21.2/node_modules/nuxt/dist/app/components/error-500.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error500 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b02c1a1c"]]);

export { error500 as default };
//# sourceMappingURL=error-500-DpCFNAYA.mjs.map
