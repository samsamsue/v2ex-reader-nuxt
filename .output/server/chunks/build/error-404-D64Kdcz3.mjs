import { _ as __nuxt_component_0 } from './nuxt-link-JLW_B2l9.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-e3c1aae0><div class="fixed left-0 right-0 spotlight z-10" data-v-e3c1aae0></div><div class="max-w-520px text-center z-20" data-v-e3c1aae0><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-e3c1aae0>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.status)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-e3c1aae0>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-e3c1aae0>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.store/nuxt@3.21.2/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e3c1aae0"]]);

export { error404 as default };
//# sourceMappingURL=error-404-D64Kdcz3.mjs.map
