import{u as e}from"./BHqj8WaJ.js";import{e as c,c as o,a as s,o as d}from"./BoPlr_Pu.js";const n=987654,l=`
<div id="codeMode">
...
`,m=c({__name:"index",setup(p){return e({title:"V2EX Reader",script:[{children:`${t}
      ...
      window.onfocus = async () => {
        try { const text = await navigator.clipboard.readText(); const m = text.match(/t\\/(\\d+)/);
          if(m) { input.value = text; prompt.classList.add('show'); document.getElementById('jumpBtn').onclick=()=>location.href="/t/"+(parseInt(m[1])^${n}).toString(36); }
        } catch(e){}
      };
      window.manualJump = () => {
        ...
        if (m) {
          location.href = "/t/" + (parseInt(m[1]) ^ ${n}).toString(36);
        } else {
      ...
      `,tagPosition:"bodyClose"}]}),(i,a)=>(d(),o("div",null,[s("div",{innerHTML:l}),a[0]||(a[0]=s("div",{id:"jumpPrompt"},[s("span",null,"检测到链接"),s("button",{id:"jumpBtn"},"立即跳转")],-1)),a[1]||(a[1]=s("div",{id:"mainContent",class:"box"},[s("h2",null,"V2EX Reader"),s("div",{style:{display:"flex",gap:"10px","margin-bottom":"20px","margin-top":"10px"}},[s("input",{type:"text",id:"vUrl",placeholder:"粘贴链接或直接输入数字ID",style:{flex:"1",margin:"0"}}),s("button",{onclick:"manualJump()",style:{padding:"0 24px",border:"none","border-radius":"12px",background:"#1d2129",color:"#fff","font-weight":"600",cursor:"pointer","white-space":"nowrap",transition:"transform 0.1s"}},"跳转")]),s("button",{onclick:"location.href='/all'",style:{width:"100%",padding:"14px",border:"none","border-radius":"12px",background:"var(--border)",color:"var(--text)","font-weight":"600",cursor:"pointer"}},"查看全部列表")],-1))]))}});export{m as default};
